...
model = joblib.load('modelJakbar.pkl')
...
# Streamlit web app
def main():
    st.title("Prediksi Harga Rumah Di Jakarta Barat")
    ...
    wilayah = st.selectbox("Wilayah", ['Angke', 'Bojong Indah', 'Cengkareng', 'Citra Garden', 'Daan Mogot', 'Duri Kepa', 'Duri Kosambi', 'Green Lake City', 'Green Ville', 'Green garden', 'Grogol', 'Intercon', 'Jelambar', 'Joglo', 'Kalideres', 'Kebon Jeruk', 'Kedoya Utara', 'Kembangan', 'Kembangan Selatan', 'Kota Bambu Utara', 'Mangga Besar', 'Meruya', 'Metland Puri', 'Metro permata', 'Palmerah', 'Permata Buana', 'Pos Pengumben', 'Puri Indah', 'Puri Mansion', 'Puri Media', 'Slipi', 'Sunrise Garden', 'Taman Meruya', 'Taman Palem', 'Taman Ratu', 'Tamansari', 'Tambora', 'Tanjung Duren', 'Tomang'])
    ...
    # Add wilayah inputs
    wilayah_values = ['Angke', 'Bojong Indah', 'Cengkareng', 'Citra Garden', 'Daan Mogot', 'Duri Kepa', 'Duri Kosambi', 'Green Lake City', 'Green Ville', 'Green garden', 'Grogol', 'Intercon', 'Jelambar', 'Joglo', 'Kalideres', 'Kebon Jeruk', 'Kedoya Utara', 'Kembangan', 'Kembangan Selatan', 'Kota Bambu Utara', 'Mangga Besar', 'Meruya', 'Metland Puri', 'Metro permata', 'Palmerah', 'Permata Buana', 'Pos Pengumben', 'Puri Indah', 'Puri Mansion', 'Puri Media', 'Slipi', 'Sunrise Garden', 'Taman Meruya', 'Taman Palem', 'Taman Ratu', 'Tamansari', 'Tambora', 'Tanjung Duren', 'Tomang']
