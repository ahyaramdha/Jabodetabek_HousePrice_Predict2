...
model = joblib.load('modelJaksel.pkl')
...
def main():
    ...
    #masukin gambar
    st.image("Distribution_of_Residuals_by_Ridge_Regression_Model_in_South_Jakarta.jpg", use_column_width=True)
    ...
    wilayah = st.selectbox("Wilayah", ['Ampera', 'Antasari', 'Bangka', 'Bintaro', 'Ciganjur', 'Cilandak', 'Cinere', 'Cipete', 'Duren Tiga', 'Fatmawati', 'Gandaria', 'Gatot Subroto', 'Jagakarsa', 'Jati Padang', 'Kalibata', 'Kebagusan', 'Kebayoran Baru', 'Kebayoran Lama', 'Kemang', 'Lebak Bulus', 'Mampang Prapatan', 'Pancoran', 'Pasar Minggu', 'Pejaten', 'Pengadegan', 'Permata Hijau', 'Pondok Indah', 'Radio Dalam', 'Ragunan', 'Sektor 3A-Bintaro', 'Senayan', 'Senopati', 'Setiabudi', 'Simprug', 'TB Simatupang', 'Tanah Kusir', 'Tanjung Barat', 'Tebet', 'patra kuningan'])
    ...
    # Add wilayah inputs
    wilayah_values = ['Ampera', 'Antasari', 'Bangka', 'Bintaro', 'Ciganjur', 'Cilandak', 'Cinere', 'Cipete', 'Duren Tiga', 'Fatmawati', 'Gandaria', 'Gatot Subroto', 'Jagakarsa', 'Jati Padang', 'Kalibata', 'Kebagusan', 'Kebayoran Baru', 'Kebayoran Lama', 'Kemang', 'Lebak Bulus', 'Mampang Prapatan', 'Pancoran', 'Pasar Minggu', 'Pejaten', 'Pengadegan', 'Permata Hijau', 'Pondok Indah', 'Radio Dalam', 'Ragunan', 'Sektor 3A-Bintaro', 'Senayan', 'Senopati', 'Setiabudi', 'Simprug', 'TB Simatupang', 'Tanah Kusir', 'Tanjung Barat', 'Tebet', 'patra kuningan']
